<template>
  <div class="flex flex-col items-center justify-center gap-6">
    <div class="">
      <div class="flex flex-col items-center justify-center gap-6">
        <h1 class="text-4xl font-bold text-center text-violet-600">Add new prize</h1>
      </div>
    </div>
    <div class="w-full">
      <form @submit.prevent class="flex flex-col items-center justify-center">
        <div class="max-w-3xl">
          ...
          <div class="flex flex-wrap items-center justify-center mb-6 -mx-3">
            ...
            <div class="flex flex-row items-center justify-center w-1/3 gap-2 px-3">
...
import { apiCreatePrize } from '@/api/prize/prize';
...
const handleCreatePrize = async () => {
  try {
    const response: APIResponse<Prize> = await apiCreatePrize(newPrize.value)
